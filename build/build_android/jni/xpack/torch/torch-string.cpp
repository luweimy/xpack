...
std::string String::ToHex(int blankByte)
{
    return torch::ToHex(m_string.c_str(), m_string.length(), blankByte);
}

std::string String::ToBinary(int blankByte)
{
    return torch::ToBinary(m_string.c_str(), m_string.length(), blankByte);
}
