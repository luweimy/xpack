...
namespace xpack {
    ...
    public:
        ...
        // iterator
        torch::collection::OrderedIterator<torch::collection::SortedSet<int32_t>::Set> GetOrderdByOffsetIncreaseIterator() {
            return m_orderdBySize.GetIterator();
        }
        torch::collection::OrderedIterator<torch::collection::SortedSet<int32_t>::Set> GetOrderdBySizeIncreaseIterator() {
            return m_orderdBySize.GetIterator();
        }
    ...
    public:
        ...
        torch::collection::OrderedIterator<std::set<int32_t>> GetIterator() {
    ...
    private:
        ...
        ContentReuser m_contentReuser;   // Metablock's content unused
        BlockReuser   m_blockReuser;
    };
}
