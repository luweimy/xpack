...
namespace torch {
    ...
    public:
         ...
         */
        std::string ToHex(int blankByte = 0) const;
        std::string ToBinary(int blankByte = 0) const;
         ...
         *  - blankByte：每隔多少个字节加一个空格，若blankByte<=0则无空格
         */
        void DumpHex(int blankByte = 0) const;
        void DumpBinary(int blankByte = 0) const;
