...
namespace xpack {
    ...
    public:
        ...
        /*
         * 会扫描找出不再使用并且删除不会影响其他Name的部分，将其删除
         */
        void CleanUnusedNameSafely();
        
        /*
         * 删除Name记录（不建议使用）
         * 注意：删除Name后，可能会导致其他Name的offset发生改变
         */
        void RemoveName(uint32_t offset, uint16_t size);
        void RemoveName(MetaHash *metahash);
